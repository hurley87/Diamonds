...
export const Footer = () => {
  return (
    <div className="w-full mx-auto flex flex-col gap-20 px-6 items-center py-20 max-w-[840px]">
      ...
      <div className="flex justify-between w-full">
        <div className="flex flex-col gap-4 text-center">
          <div className="uppercase">Telephone</div>
          <div className="text-[#62696B]">+49 89 200 03 0800</div>
        </div>
        <div className="flex flex-col gap-4 text-center">
          <div className="uppercase">Headquarters</div>
